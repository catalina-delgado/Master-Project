...
class MapSwinTransformer_prueba5(GradCAM):
    def __init__(self):
        self.code_image = "985"
    ...
    def generate_gradcam(self):
        model_path = "trained_models\Model_swinTransformer_prueba5_04S-UNIWARD_1732391371.2743082\saved-model.hdf5"
        layer_name = 'conv2d_8'
        ...
        self.save_and_overlay_gradcam(self.image_path, gradcam, f"Model_swinTransformer_prueba5-{self.code_image}", layer_name)