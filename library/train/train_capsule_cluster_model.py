...
from src.models.capsule_cluster_model import BlocksCapsule

class TrainingCapsuleCluater(Main):
    def __init__(self, epochs, batch_size):
        self.EPHOCS = epochs
        self.BATCH_SIZE = batch_size

    def train_capsule_cluster_model(self):
        ...
        name="Model_"+'CAPSNET_CLUSTER_prueba1'+"_"+base_name
